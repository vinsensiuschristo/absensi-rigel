                                        ...
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between align-items-center mb-50">
                                                <h4 class="card-title mb-0">Dashboard List<span
                                                    class="break-320-480-none">Dosen</span></h4>
                                            <div class="d-flex">
                                                <a href="{{ route('superadmin.dosen.create') }}" class="btn btn-primary btn-sm mr-2">Tambah Dosen</a>
                                            </div>
                                            </div>
                                            ...
                                            <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <!-- Actions -->
                                                        <td>
                                                            <a href="{{ route('superadmin.dosen.show', $dosen->id) }}" class="action-item mr-2" data-bs-toggle="tooltip" title="Show">
                                                                <i class="fa fa-eye"></i>
                                                            </a>
                                                            <a href="{{ route('superadmin.dosen.edit', $dosen->id) }}" class="action-item mr-2" data-bs-toggle="tooltip" title="Edit">
                                                                <i class="fa fa-edit"></i>
                                                            </a>
                                                            <form action="{{ route('superadmin.dosen.destroy', $dosen->id) }}" method="POST">
                                                                @method('DELETE')
                                                                @csrf
