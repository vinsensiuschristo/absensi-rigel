                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between align-items-center mb-50">
                                                <h4 class="card-title mb-0">Lihat <span
                                                    class="break-320-480-none">Dosen</span></h4>
                                            <div class="d-flex">
                                                <a href="{{ route('superadmin.dosen') }}" class="btn btn-danger btn-sm mr-2">Kembali</a>
                                            </div>
                                            </div>
    
                                                <div class="form-group mb-3">
                                                    <label for="npm">NPM</label>
                                                    <input type="number" class="form-control" id="npm" name="npm" value="{{ $user->npm }}" disabled>
                                                    @error('npm')
                                                ...
                                                <a href="{{ route('superadmin.dosen.edit', $user->id) }}" class="btn btn-danger btn-sm mr-2">Edit</a>
                                        </div> <!-- end card body-->
                                    </div> <!-- end card -->
                                </div><!-- end col-->
                            </div>
