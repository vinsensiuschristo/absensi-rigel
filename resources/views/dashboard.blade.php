                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 box-margin">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 col-xs-12">
                                                <form>
                                                    ...
                                                    <div class="form-group mb-2">
                                                        <label for="exampleInputPassword11">Divisi</label>
                                                        <input type="text" class="form-control" id="exampleInputEmail111" placeholder="Enter Username" disabled value="Divisi Produk">
                                                    </div>
                                                    <div class="form-group mb-2">
                                                        <label for="exampleInputPassword11">JABATAN</label>
                                                        <input type="text" class="form-control" id="exampleInputEmail111" placeholder="Enter Username" disabled value="JABATAN BOS BESAR">
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
                                ...
                                <div class="card card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-xs-12">
                                            <img src="{{ url('storage/app/uploads/664eb3493f9a8.png') }}" alt="test" title="test" />
                                        </div>
                                    </div>
                                </div>
                            </div>
